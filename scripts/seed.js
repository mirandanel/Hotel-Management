...
const connectDB = async () => {
    ...
    try {
        ...
        { name: 'John Doe', email: 'john.doe@email.com', phone: '+1234567890', address: '123 Main St, New York' },
        { name: 'Jane Smith', email: 'jane.smith@email.com', phone: '+1234567891', address: '456 Oak Ave, Los Angeles' },
        { name: 'Bob Johnson', email: 'bob.johnson@email.com', phone: '+1234567892', address: '789 Pine Rd, Chicago' },
        { name: 'Alice Williams', email: 'alice.williams@email.com', phone: '+1234567893', address: '321 Elm St, Houston' },
        { name: 'Charlie Brown', email: 'charlie.brown@email.com', phone: '+1234567894', address: '654 Maple Dr, Phoenix' }
        ]);
